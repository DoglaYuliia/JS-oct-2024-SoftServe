...
function changeArray(array, changeFunc) {
  // changeFunc - callback function

  for (let i = 0; i < array.length; i++) array[i] = changeFunc(array[i]);
}
...
changeArray(numbers, function (x) {
  return x * x;
});
